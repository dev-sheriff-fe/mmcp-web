        ...
        <div className="flex w-full flex-col items-center md:flex-row">
          ...
          <div className="flex w-full flex-col items-center space-y-4 ms-auto md:flex-row md:space-y-0 xl:w-1/2">
            ...
            <button
              ...
              className="h-12 w-full rounded bg-accent px-5 text-base font-light text-light transition-colors hover:bg-accent-hover focus:bg-accent-hover focus:outline-0 md:w-auto md:ms-6"
            >
